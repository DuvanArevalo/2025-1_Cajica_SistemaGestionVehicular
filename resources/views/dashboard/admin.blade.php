                    ...
                    <div class="card-body">
                        <form method="GET" action="{{ route('admin.dashboard') }}" class="row g-3">
                            ...
                            <div class="col-12 d-flex justify-content-end gap-2 mt-3">
                                ...
                                <a href="{{ route('admin.dashboard') }}" class="btn btn-outline-secondary">Limpiar filtros</a>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row g-2">
                            <div class="col-6 mb-2">
                                <a href="{{ route('admin.users.index') }}" class="btn btn-outline-primary w-100 h-100 d-flex align-items-center justify-content-center">
                                    <i class="bi bi-people me-2"></i> Usuarios
                                </a>
                            </div>
                            <div class="col-6 mb-2">
                                <a href="{{ route('admin.vehicles.index') }}" class="btn btn-outline-success w-100 h-100 d-flex align-items-center justify-content-center">
                                    <i class="bi bi-truck me-2"></i> Vehículos
                                </a>
                            </div>
                            <div class="col-6 mb-2">
                                <a href="{{ route('admin.alerts.index') }}" class="btn btn-outline-warning w-100 h-100 d-flex align-items-center justify-content-center">
                                    <i class="bi bi-exclamation-triangle me-2"></i> Alertas
                                </a>
                            </div>
                            <div class="col-6 mb-2">
                                <a href="{{ route('admin.preoperational-forms.index') }}" class="btn btn-outline-info w-100 h-100 d-flex align-items-center justify-content-center">
