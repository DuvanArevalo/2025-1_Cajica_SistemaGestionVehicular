        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route(Auth::user()->role->name . '.users.update', $user->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name1') is-invalid @enderror" id="name1" name="name1" value="{{ old('name1', $user->name1) }}" required>
                                    @error('name1')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name2') is-invalid @enderror" id="name2" name="name2" value="{{ old('name2', $user->name2) }}">
                                    @error('name2')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('lastname1') is-invalid @enderror" id="lastname1" name="lastname1" value="{{ old('lastname1', $user->lastname1) }}" required>
                                    @error('lastname1')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('lastname2') is-invalid @enderror" id="lastname2" name="lastname2" value="{{ old('lastname2', $user->lastname2) }}">
                                    @error('lastname2')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('document_number') is-invalid @enderror" id="document_number" name="document_number" value="{{ old('document_number', $user->document_number) }}" required>
