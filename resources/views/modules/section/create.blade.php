        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <h6>Crear Nueva Sección</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route(Auth::user()->role->name . '.sections.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" 
                                                        ...
                                                        {{ (is_array(old('vehicle_types')) && in_array($vehicleType->id, old('vehicle_types'))) ? 'checked' : '' }}>
