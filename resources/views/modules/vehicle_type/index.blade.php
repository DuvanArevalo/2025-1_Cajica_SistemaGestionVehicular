    ...
    <div class="row">
        <div class="col-12 mb-4">
            <div class="card-header text-center">
                <h2 class="mb-0">Listado de Tipos de Vehículo</h2>
            </div>
            <br>
            <div class="mb-3 d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route(Auth::user()->role->name .'.vehicle-types.create') }}" class="btn btn-primary">
                    <i class="bi bi-plus-circle me-1"></i> Nuevo Tipo de Vehículo
                </a>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="card mb-4">
                <div class="card-header">
                    <h5 class="mb-0">Filtrar Tipos de Vehículo</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route(Auth::user()->role->name .'.vehicle-types.index') }}" method="GET" class="row g-3">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3 d-flex align-items-end">
                            ...
                            <a href="{{ route(Auth::user()->role->name .'.vehicle-types.index') }}" class="btn btn-secondary ms-2">
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $vehicleType->created_at->format('d/m/Y') }}</td>
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="{{ route(Auth::user()->role->name .'.vehicle-types.show', $vehicleType->id) }}" class="btn btn-sm btn-info">
                                                <i class="bi bi-eye"></i>
                                                Ver
                                            </a>
                                            <a href="{{ route(Auth::user()->role->name .'.vehicle-types.edit', $vehicleType->id) }}" class="btn btn-sm btn-warning">
                                ...
                                @empty
                                <tr>
                                    <td colspan="4" class="text-center py-4">No se encontraron tipos de vehículo</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-4">
                            <div>
                                Mostrando {{ $vehicleTypes->firstItem() ?? 0 }} a {{ $vehicleTypes->lastItem() ?? 0 }} de {{ $vehicleTypes->total() ?? 0 }} resultados
                            </div>
                            <div>
                                {{ $vehicleTypes->links() }}
                            </div>
